...
jupyter:
	...
	@sleep 10
	@echo "Jupyter token:"
	@docker logs ${JUPYTER_CONTAINER_NAME} 2>&1 | grep '\?token\=' | tail -n 1 | cut -d '=' -f2
	@echo '==========================================================='
...
airflow-restart:
	@echo '__________________________________________________________'
	@echo 'Restart Airflow Instance ...'
	@echo '__________________________________________________________'
	@docker compose -f ./docker/docker-compose-airflow.yml --env-file .env down
	@echo '__________________________________________________________'
	@docker compose -f ./docker/docker-compose-airflow.yml --env-file .env up -d
	@echo '==========================================================='
...
postgres-create-warehouse:
	...
	@docker exec -it ${POSTGRES_CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DB} -f sql/ddl-dw.sql
	@echo 'Creating Warehouse DB Successfull...'

postgres-create-schema:
	@echo '__________________________________________________________'
	@echo 'Creating schema...'
	@echo '_________________________________________'
	@docker exec -it ${POSTGRES_CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DWH} -f sql/ddl-schema.sql
	@echo 'Creating schema Successfull...'

postgres-create-table:
	@echo '__________________________________________________________'
	@echo 'Creating tables...'
	@echo '_________________________________________'
	@docker exec -it ${POSTGRES_CONTAINER_NAME} psql -U ${POSTGRES_USER} -d ${POSTGRES_DWH} -f sql/ddl-fact.sql
	@echo 'Creating table Successfull...'
